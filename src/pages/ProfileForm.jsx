...
const CreateProfile = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto pb-24 md:pb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            {form.industry === "Other" && (
              <input
                type="text"
                className={`w-full border rounded-md mt-2 p-2 bg-[#F0F0F0] transition-colors duration-200 ${isFormDisabled ? "opacity-50 cursor-not-allowed" : ""}`}
                placeholder="Please Specify Your Industry"
                value={form.customIndustry}
                onChange={e => setForm({ ...form, customIndustry: e.target.value })}
                disabled={isFormDisabled}
                required
                title="Enter your specific industry if not listed above"
              />
            )}
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <select
              ...
              required
              title="Select the year your company was established"
            >
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <select
              ...
              required
              title="Select the range for total number of employees"
            >
          ...
          <div className="col-span-2">
            <div className="mb-2">
              ...
              <textarea
                id="bio"
                className={`w-full border rounded-md mt-1 p-2 bg-[#F0F0F0] transition-colors duration-200 ${errors.bio ? "border-red-500" : ""} ${isFormDisabled ? "opacity-50 cursor-not-allowed" : ""}`}
                rows={4}
                value={form.bio}
                onChange={e => setForm({ ...form, bio: e.target.value })}
                disabled={isFormDisabled}
                placeholder="Enter a detailed description of your company (minimum 100 characters)"
                required
                title="Enter a detailed description of your company (minimum 100 characters)"
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="col-span-2 md:col-span-1">
            <FormInput
              ...
              required
              disabled={isFormDisabled}
              placeholder="Enter Your Job Title (e.g., Project Manager)"
            />
          </div>
          <div className="col-span-2 md:col-span-1">
            <FormInput
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40 p-4">
        <div className="max-w-4xl mx-auto flex justify-end gap-3">
          <button
            className={`px-6 py-3 rounded-lg bg-gray-200 hover:bg-gray-300 transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] ${isFormDisabled ? "opacity-60 cursor-not-allowed" : ""}`}
            onClick={() => navigate("/sign_up")}
            disabled={isFormDisabled}
            title="Cancel and go back to sign up"
          >
            Cancel
          </button>
          <button
            className={`px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] ${isFormDisabled ? "opacity-60 cursor-not-allowed" : ""}`}
            onClick={() => handleSubmit()}
            disabled={isFormDisabled}
            title={loading ? "Creating your profile..." : redirecting ? "Redirecting..." : "Create your profile"}
          >
            {loading ? (
              <>
