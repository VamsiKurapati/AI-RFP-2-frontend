    ...
    <div className="min-h-screen bg-[#F8F9FB] pb-10">
      ...
      <div className="w-full mx-auto px-8 md:px-12 mt-20">
              ...
              <div className="bg-white rounded-xl border border-[#E5E7EB] p-6 flex flex-col">
                ...
                {companyData?.employees && companyData?.employees.length > 0 ? (
                  <>
                    ...
                    >
                      {showViewAllTeam ? "View Less" : "View All"}
                    </button>
                  </>
                ) : (
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4">
          ...
          <button
            className="bg-[#2563EB] text-white px-8 py-2 rounded-lg font-medium text-lg hover:bg-[#1d4ed8] w-auto mx-auto disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
            onClick={handleSaveAndNext}
            disabled={isGeneratingProposal}
            title={isGeneratingProposal ? "Generating your proposal..." : "Save changes and generate proposal"}
          >
            {isGeneratingProposal ? (
              <>
