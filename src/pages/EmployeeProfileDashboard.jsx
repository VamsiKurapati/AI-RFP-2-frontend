...
import { MdOutlineEdit, MdOutlineAddAPhoto, MdOutlineBusinessCenter, MdOutlineLocationOn, MdOutlineMail, MdOutlineCall, MdOutlineClose, MdOutlineCheck, MdOutlineCalendarToday, MdOutlineHelp } from "react-icons/md";
...
const EmployeeProfileDashboard = () => {
  ...
  const employeeProfileOverviewRef = useRef(null);
  const employeeProfileProposalsRef = useRef(null);
      ...
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            title="Retry loading employee profile"
          >
            Retry
          </button>
        </div>
  ...
  useEffect(() => {
    if (employeeProfileOverviewRef.current) {
      registerRef('employee-profile-overview', employeeProfileOverviewRef);
    }
  }, [registerRef]);

  useEffect(() => {
    if (employeeProfileProposalsRef.current) {
      registerRef('employee-profile-proposals', employeeProfileProposalsRef);
    }
  }, [registerRef]);

  // Fallback: Also register refs on mount in case callback refs don't fire
  useEffect(() => {
    if (employeeProfileOverviewRef.current) registerRef('employee-profile-overview', employeeProfileOverviewRef);
    if (employeeProfileProposalsRef.current) registerRef('employee-profile-proposals', employeeProfileProposalsRef);
  }, [registerRef]);
  ...
  return (
    <div className="h-full relative">
      ...
      <div className="bg-[#F8F9FA] w-full mt-20 md:top-20 left-0 right-0 z-10 px-8 md:px-12 py-[14px] border-b border-[#2563EB]">
        ...
        <div ref={employeeProfileOverviewRef} className="w-full">
          ...
          <div className="flex flex-row items-center justify-between gap-4 mb-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                title="Edit your employee profile"
              >
      ...
      {/* Proposals Sections */}
      <div ref={employeeProfileProposalsRef} className="mt-4 px-8 md:px-12 pb-8">
