...
const Sidebar = ({ isMobile = false, onClose = () => { }, active = "Overview", onSelect = () => { }, setProfileSidebarRef = null }) => (
  <div
    ref={setProfileSidebarRef}
...
const RightSidebar = ({ deadlines, activity, isMobile, onClose, deadlinesRef, setProfileDeadlinesRef = null }) => {
  const content = (
    <div ref={setProfileDeadlinesRef} className="flex-1 h-full overflow-y-auto custom-scrollbar p-6">
    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-6 w-96 h-full max-w-[90vw] z-50 overflow-y-auto custom-scrollbar">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} disabled={addingTeamMember} className="text-gray-500 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Close modal">
            <MdOutlineClose className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              title="Enter the full name of the team member"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              disabled={addingTeamMember}
              required
              title="Provide a brief description of the team member"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={addingTeamMember}
              required
              title="Enter the highest educational qualification"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={addingTeamMember}
              required
              title="Enter the job title or role"
            />
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              disabled={addingTeamMember}
              className="flex-1 px-4 py-2 bg-[#2563EB] text-white rounded-lg hover:bg-[#1d4ed8] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-200"
              title={addingTeamMember ? "Adding team member..." : "Add this team member"}
            >
              {addingTeamMember ? (
                <>
    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-6 w-96 max-w-[90vw] z-50 max-h-[90vh] overflow-y-auto custom-scrollbar">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} disabled={addingCaseStudy} className="text-gray-500 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Close modal">
            <MdOutlineClose className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              title="Enter the title of the case study"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={addingCaseStudy}
              required
              title="Enter the company name associated with this case study"
            />
          </div>
          ...
          <div>
            ...
            <div className={`border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#2563EB] transition-colors ${addingCaseStudy ? 'opacity-50 cursor-not-allowed' : ''}`} title={addingCaseStudy ? "Please wait..." : "Click to upload PDF or TXT file (max 5MB)"}>
              <input
                type="file"
                accept=".pdf,.txt"
                ...
                disabled={addingCaseStudy}
                required
                title="Upload PDF or TXT file (max 5MB)"
              />
              <label htmlFor="file-upload" className={`cursor-pointer ${addingCaseStudy ? 'cursor-not-allowed' : ''}`}>
                <div className="space-y-2">
              ...
              <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={addingCaseStudy}
                    title={addingCaseStudy ? "Please wait..." : "Remove uploaded file"}
                  >
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              disabled={addingCaseStudy}
              className="flex-1 px-4 py-2 bg-[#2563EB] text-white rounded-lg hover:bg-[#1d4ed8] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-200"
              title={addingCaseStudy ? "Adding case study..." : "Add this case study"}
            >
              {addingCaseStudy ? (
                <>
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white inline-block mr-2"></div>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-6 w-96 max-w-[90vw] z-50 max-h-[90vh] overflow-y-auto custom-scrollbar">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            title={uploadingDocument ? "Please wait for upload to complete" : "Close modal"}
          >
            <MdOutlineClose className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled={uploadingDocument}
              required
              title="Enter a name for this document"
            />
          </div>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#2563EB] transition-colors">
              <input
                ...
                disabled={uploadingDocument}
                required
                title="Upload PDF or TXT file (disabled during upload)"
              />
              <label
                htmlFor="document-upload"
                className={`cursor-pointer ${uploadingDocument ? 'opacity-50 cursor-not-allowed' : ''}`}
                title={uploadingDocument ? "Please wait for upload to complete" : "Click or drag to upload file"}
              >
                <div className="space-y-2">
                  <div className="text-gray-600">
                    <svg className="mx-auto h-12 w-12" stroke="currentColor" fill="none" viewBox="0 0 48 48">
              ...
              <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={uploadingDocument}
                    title={uploadingDocument ? "Please wait for upload to complete" : "Remove uploaded file"}
                  >
                    <MdOutlineClose className="w-4 h-4" />
                  </button>
                </div>
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              disabled={uploadingDocument}
              className="flex-1 px-4 py-2 border rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              title={uploadingDocument ? "Please wait for upload to complete" : "Close without uploading"}
            >
              Cancel
            </button>
            <button
              ...
              onClick={(e) => handleSubmit(e)}
              disabled={uploadingDocument}
              className="flex-1 px-4 py-2 bg-[#2563EB] text-white rounded-lg hover:bg-[#1d4ed8] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
              title={uploadingDocument ? "Uploading document..." : "Upload and add document"}
            >
              {uploadingDocument ? (
                <>
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white inline-block mr-2"></div>
...
const CompanyProfileDashboard = () => {
  ...
  const { setOnboardingCompleted } = useUser();
  ...
  const handleRestartOnboarding = () => {
    ...
    // Navigate to dashboard to start the tour from the beginning
    navigate('/dashboard');
    // Show success message
    Swal.fire({
      title: 'Onboarding tour restarted!',
      text: 'The tour will begin when you reach the dashboard.',
      icon: 'success',
      timer: 2000,
      showConfirmButton: false,
    });
    ...
    <div className="h-full relative">
      ...
      <div ref={setProfileOverviewRef} className="bg-[#F8F9FA] w-full mt-20 lg:mt-0 lg:fixed lg:top-20 left-0 right-0 z-10 shadow-md px-8 lg:px-12 py-[14px]">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-row items-center justify-between gap-4 lg:hidden mb-2">
            ...
            {/* Edit Button and Onboarding Tour Button */}
            <div className="flex items-center gap-2">
              <button
              ...
              >
                <MdOutlineHelp className="w-5 h-5 shrink-0" /> Tour
              </button>
            </div>
          </div>
          ...
          <div className="hidden lg:flex flex-row items-start gap-4 flex-wrap w-full">
            ...
            {/* Edit Button and Onboarding Tour Button */}
            <div className="flex items-start mt-0 gap-2">
              <button
      ...
      <div className="relative hidden lg:block lg:mt-[20rem]">
        <div className="relative z-10">
          <Sidebar active={activeTab} onSelect={handleSetActiveTab} setProfileSidebarRef={setProfileSidebarRef} />
        </div>
        {showRightSidebar && (
      ...
      <div className="hidden lg:block mt-[20rem]">
        <RightSidebar deadlines={companyData?.deadlines || []} activity={companyData?.activity || []} deadlinesRef={profileDeadlinesRef} setProfileDeadlinesRef={setProfileDeadlinesRef} />
      </div>
      {showRightSidebar && (
        <RightSidebar
          isMobile
      ...
      <button
        className="block lg:hidden fixed bottom-4 right-4 z-40 bg-[#2563EB] text-white px-4 py-2 rounded-full shadow transition-all duration-200 hover:shadow-lg transform hover:scale-[1.05] active:scale-[0.95] hover:bg-[#1d4ed8]"
        onClick={() => setShowRightSidebar(true)}
        title="View activity and deadlines"
      >
        Activity
      </button>
                ...
                <div className="flex flex-col gap-4" data-tour="team-section">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      ...
                      title="Add a new team member to your company"
                    >
                      ...
                      companyData.employees.map((member, i) => (
                        <div key={i} className="rounded-xl shadow bg-[#F9FAFB] p-4 flex flex-col gap-2 items-start relative">
                          ...
                          <button
                            ...
                            title={deletingEmployee[member.employeeId] ? "Deleting team member..." : "Remove this team member"}
                          >
                          ...
                          <div className="flex gap-4 mt-2 mx-auto">
                            <button
                              ...
                              className="text-[#2563EB] text-[15px] hover:underline transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                              title="View team member's profile details"
                            >
                              View Profile
                            </button>
                            <button
                              ...
                              className="text-[#2563EB] text-[15px] hover:underline transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                              title="Contact this team member"
                            >
                              Contact
                            </button>
                          </div>
                ...
                <div className="flex flex-1 gap-4 sm:justify-end items-center">
                  <div className="relative flex-1">
                    <input
                      ...
                      title="Search for proposals by title or client name"
                    />
                    <MdOutlineSearch className="absolute top-1/2 left-4 -translate-y-1/2 text-[#9CA3AF] w-5 h-5" title="Search proposals" />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-2" data-tour="documents-section">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  title="Add a new document to your company"
                >
                    ...
                    <div key={i} className="flex flex-col bg-[#F9FAFB] rounded-xl p-4 shadow-sm border border-[#E5E7EB]">
                      <div className="flex items-center justify-end">
                        <button
                          ...
                          title={deletingDocument[doc._id] ? "Deleting document..." : "Delete this document"}
                        >
