            ...
            <div className="w-full max-w-6xl mx-auto p-8 mt-20">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        {(currentPlan?.plan_name === "Free" || !currentPlan) && (
                            <button
                                ...
                                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition-colors shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
                                title="Upgrade to a higher plan for more features"
                            >
                                Upgrade Plan
                            </button>
                        )}
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                                <button
                                    ...
                                    title="Open RFP link in a new tab"
                                >
                    ...
                    {!uploadedFile && !fileUploading ? (
                        ...
                        >
                            ...
                            <input
                                ...
                                title="Upload PDF file (max 5MB)"
                            />
                            <label
                                htmlFor="file-upload"
                                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg cursor-pointer transition-colors shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
                                title="Upload a PDF file (max 5MB) for compliance checking"
                            >
                                <FiUpload />
                                Choose File
                            </label>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-4">
                    <button
                        ...
                        disabled={complianceCheck || fileUploading}
                        title={complianceCheck || fileUploading ? "Please wait..." : "Go back to previous page"}
                    >
                        <IoIosArrowBack className="text-xl" />
                        Back
                    </button>
                    <button
                        className="bg-[#2563EB] text-white px-8 py-2 rounded-lg font-medium text-lg hover:bg-[#1d4ed8] w-auto mx-auto disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
                        onClick={() => handleCheckCompliance()}
                        disabled={complianceCheck || fileUploading}
                        title={complianceCheck ? "Checking compliance..." : fileUploading ? "Please wait for file upload to complete" : !uploadedFile ? "Please upload a proposal document first" : "Check compliance of your proposal document"}
                    >
                        {complianceCheck ? (
