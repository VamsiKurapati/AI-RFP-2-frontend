...
import { IoIosArrowBack, IoMdCloseCircle, IoIosArrowDown, IoIosArrowUp } from "react-icons/io";
...
const AdvancedComplianceCheck = () => {
    ...
    const [isLoadingCompetitorAnalysis, setIsLoadingCompetitorAnalysis] = useState(false);
    ...
    const handleCompetitorAnalysis = async () => {
        ...
        try {
            ...
            Swal.fire({
                title: "Error",
                text: error.response?.data?.message || "Failed to fetch competitor analysis. Please try again.",
                icon: "error",
                confirmButtonText: "OK"
            });
        } finally {
            setIsLoadingCompetitorAnalysis(false);
        }
    };
        ...
        <div className="min-h-screen overflow-y-auto">
            ...
            <div className="w-full mx-auto p-8 mt-20">
                ...
                <div className="flex flex-col gap-4">
                    {openSections.basicCompliance ? (
                        <div className="border-2 border-[#2563EB] rounded-lg p-6 mb-10">
                            <button
                                onClick={() => toggleSection('basicCompliance')}
                                className="flex items-center justify-between text-[20px] font-semibold mb-4 transition-all duration-200 cursor-pointer text-black hover:text-[#2563EB] w-full"
                            >
                                <span>Basic Compliance Check</span>
                                <IoIosArrowUp className="w-6 h-6 shrink-0" />
                            </button>
                            {/* Compliance Cards */}
                        ...
                        <button
                            onClick={() => toggleSection('basicCompliance')}
                            className={`flex items-center justify-between text-[20px] font-semibold mt-4 mb-4 transition-all duration-200 cursor-pointer rounded-lg px-4 py-2 bg-[#2563EB] text-white hover:bg-[#1D4ED8]`}
                        >
                            <span>Basic Compliance Check</span>
                ...
                <div className="flex flex-col gap-4">
                    {openSections.advancedCompliance ? (
                        <div className="bg-white border-2 border-[#2563EB] rounded-lg p-6 mb-10">
                            <button
                                onClick={() => toggleSection('advancedCompliance')}
                                className="flex items-center justify-between text-[20px] font-semibold mb-6 transition-all duration-200 cursor-pointer text-black hover:text-[#2563EB] w-full"
                            >
                                <span>Advanced Compliance Check</span>
                                <IoIosArrowUp className="w-6 h-6 shrink-0" />
                            </button>
                ...
                <div className="flex flex-col gap-4">
                    {openSections.bidStrategy ? (
                        <div className="border-2 border-[#2563EB] rounded-lg p-6 mb-10">
                            <button
                                onClick={() => toggleSection('bidStrategy')}
                                className="flex items-center justify-between text-[20px] font-semibold mb-4 transition-all duration-200 cursor-pointer text-black hover:text-[#2563EB] w-full"
                            >
                                <span>Bid Strategy Insights</span>
                                <IoIosArrowUp className="w-6 h-6 shrink-0" />
                            </button>
                ...
                {advancedComplianceCheck && advancedComplianceCheck["Overall Compliance Score"] !== undefined && advancedComplianceCheck["Overall Compliance Rating"] && (
                    <div className="flex flex-col gap-4">
                        <button
                            onClick={() => toggleSection('overallScore')}
                            className={`flex items-center justify-between text-[20px] font-semibold mt-4 mb-4 transition-all duration-200 cursor-pointer rounded-lg px-4 py-2 ${openSections.overallScore
                                ? 'text-black hover:text-[#2563EB]'
                                : 'bg-[#2563EB] text-white hover:bg-[#1D4ED8]'
                                }`}
                        >
                            <span>Overall Compliance Score</span>
                            {openSections.overallScore ? (
                                <IoIosArrowUp className="w-6 h-6 shrink-0" />
                            ) : (
                                <IoIosArrowDown className="w-6 h-6 shrink-0" />
                            )}
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between mt-8 gap-4">
                    ...
                    <button
                        className="bg-[#2563EB] text-white px-8 py-2 rounded transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] hover:bg-[#1D4ED8] text-[16px] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        onClick={handleCompetitorAnalysis}
                        disabled={isLoadingCompetitorAnalysis}
                        title="Get AI Competitor Analysis"
                    >
                        {isLoadingCompetitorAnalysis ? (
                            <>
