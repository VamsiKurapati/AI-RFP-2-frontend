...
export default function ChangePassword() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] flex flex-col md:flex-row items-center justify-center px-6 py-12 pb-24 md:pb-28">
            <ToastContainer />
                ...
                <form id="change-password-form" onSubmit={handleChangePassword}>
                    <div className="mb-4 relative">
                        ...
                        <input 
                            ...
                            disabled={loading}
                            className="w-full px-3 py-2 pr-10 border border-[#D1D5DB] rounded-md focus:ring-2 focus:ring-[#2563EB] focus:border-transparent transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed" 
                            required 
                        />
                        <button 
                            type="button" 
                            className="absolute right-3 top-10 text-gray-500 hover:text-gray-700 transition-colors duration-200 disabled:opacity-50" 
                    ...
                    <div className="flex justify-end gap-2 mb-4">
                        <button 
                            type="button" 
                            className="w-1/2 bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed" 
                            onClick={() => navigate(-1)}
                            disabled={loading}
                        ...
                        <button 
                            type="submit" 
                            className="w-1/2 bg-[#2563EB] text-white px-4 py-2 rounded-md hover:bg-[#1D4ED8] flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed" 
                            disabled={loading}
                            title={loading ? "Changing password..." : "Change your password"}
                        >
                            {loading ? <FaSpinner className="animate-spin" /> : <FaLock className="text-white text-[18px]" />}
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40 p-4 md:hidden">
                <div className="max-w-lg mx-auto flex gap-2">
                    <button 
                        type="button" 
                        className="w-1/2 bg-gray-500 text-white px-4 py-3 rounded-md hover:bg-gray-600 flex items-center justify-center gap-2 transition-all duration-200 shadow-md" 
                        onClick={() => navigate(-1)}
                        disabled={loading}
                        title="Cancel and go back"
                    >
                    ...
                    <button 
                        ...
                        className="w-1/2 bg-[#2563EB] text-white px-4 py-3 rounded-md hover:bg-[#1D4ED8] flex items-center justify-center gap-2 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed" 
                        disabled={loading}
                        title={loading ? "Changing password..." : "Change your password"}
                    >
                        {loading ? <FaSpinner className="animate-spin" /> : <FaLock className="text-white text-[18px]" />}
