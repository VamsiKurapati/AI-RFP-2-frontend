    ...
    const plans = [
        {
            ...
            features: [
                ...
                `AI - RFP Proposal Generations - Upto ${basicPlan.maxRFPProposalGenerations || 0} times per month`,
                `AI - Grant Proposal Generations - Upto ${basicPlan.maxGrantProposalGenerations || 0} times per month`,
                "Rich Proposal Editor",
                `AI Magic Brush - ${basicPlan.maxMagicBrushUsage || 0} times per month`,
        ...
        },
        {
            ...
            features: [
                ...
                `AI Magic Brush - ${proPlan.maxMagicBrushUsage || 0} times per month`,
                `AI Image Generation for Proposals - Upto ${proPlan.maxImageGenerationUsage || 0} times per month`,
                "AI Chat Assist",
    ...
    if (!enterprisePlan.isContact) {
        plans.push({
            ...
            features: [
                ...
                `AI - RFP Proposal Generations - Upto ${enterprisePlan.maxRFPProposalGenerations || 0} times per month`,
                `AI - Grant Proposal Generations - Upto ${enterprisePlan.maxGrantProposalGenerations || 0} times per month`,
                `${enterprisePlan.maxEditors || 0} Editors, ${enterprisePlan.maxViewers || 0} Viewers, Unlimited Members`,
                "Dedicated Support",
            ],
            missingFeatures: [],
