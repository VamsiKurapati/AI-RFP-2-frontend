    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                title={loading ? "Processing your payment..." : !stripe ? "Payment system is loading..." : billingCycle === 'yearly' ? `Complete payment of $${selectedPlan.yearlyPrice} yearly` : `Complete payment of $${selectedPlan.monthlyPrice} monthly`}
            >
                {loading ? (
