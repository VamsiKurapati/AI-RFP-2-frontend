            ...
            <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="text-gray-400 hover:text-gray-600 text-2xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            title={isFetchingGrantProposal || isGenerating ? "Please wait..." : "Close this form"}
                        >
                            ×
                        </button>
                    </div>
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            title="Enter a comprehensive summary of your proposed project"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isGenerating || isFetchingGrantProposal}
                            title="Describe the main objectives of your proposed project"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isGenerating || isFetchingGrantProposal}
                            title="Describe the key activities and tasks of your proposed project"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isGenerating || isFetchingGrantProposal}
                            title="Describe the beneficiaries and target population of your proposed project"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isGenerating || isFetchingGrantProposal}
                            title="Describe the geographic scope of your project"
                        />
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isGenerating || isFetchingGrantProposal}
                                title="Select the start date for your project"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <textarea
                                ...
                                disabled={isGenerating || isFetchingGrantProposal}
                                title="Enter the estimated duration of your project (e.g., 24 Months, 3 Years)"
                            />
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={isGenerating || isFetchingGrantProposal}
                                    title="Enter the total project cost in dollars"
                                />
                            </div>
                            <div>
                                <label className="block text-xs font-medium text-gray-600 mb-1">
                                ...
                                <input
                                    ...
                                    disabled={isGenerating || isFetchingGrantProposal}
                                    title="Enter the amount you are requesting from the funder in dollars"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <textarea
                                    ...
                                    disabled={isGenerating || isFetchingGrantProposal}
                                    title="Describe your cost share contribution and any partner contributions"
                                />
                            </div>
                            <div>
                                <label className="block text-xs font-medium text-gray-600 mb-1">
                                ...
                                <textarea
                                    ...
                                    disabled={isGenerating || isFetchingGrantProposal}
                                    title="Provide detailed budget breakdown with amounts, reasons, and justifications"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isGenerating || isFetchingGrantProposal}
                            title="Describe the methods and metrics you will use to measure the success of your project"
                        />
                    </div>
                </div>
                ...
                <div className="p-6 border-t border-gray-200 grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-3 justify-end">
                    <button
                        onClick={onClose}
                        disabled={isGenerating || isFetchingGrantProposal}
                        className="text-center px-4 py-2 text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] disabled:bg-gray-400 disabled:cursor-not-allowed"
                    ...
                    <button
                        ...
                        className="text-center px-6 py-2 text-white rounded-md flex items-center justify-center gap-2 transition-all duration-200 bg-blue-600 hover:bg-blue-700 cursor-pointer shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] disabled:bg-gray-400 disabled:cursor-not-allowed"
                        title={isFetchingGrantProposal ? "Fetching grant proposal..." : "Fetch AI-generated grant proposal"}
                    >
                    ...
                    <button
                        ...
                        disabled={isGenerating || isFetchingGrantProposal}
                        className={`text-center px-6 py-2 text-white rounded-md flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] ${isGenerating
                            ? 'bg-gray-400 cursor-not-allowed'
                            : 'bg-blue-600 hover:bg-blue-700'
                            }`}
                        title={isGenerating ? "Generating proposal..." : isFetchingGrantProposal ? "Please wait..." : "Continue with this proposal"}
                    >
                        {isGenerating && (
                            <FaSpinner className="animate-spin h-4 w-4" />
                        )}
