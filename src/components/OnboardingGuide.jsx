...
const OnboardingGuide = () => {
    ...
    const pageSteps = {
        '/dashboard': [
            {
                ...
                content: 'Welcome to your Dashboard! Here you can see the overview of proposal generations, and your company\'s subscription status at a glance.',
                placement: 'bottom',
            ...
            },
            {
                ...
                content: 'Quick statistics show your total proposal generations, in-progress proposal generations, submitted proposals, and won proposals.',
                placement: 'bottom',
            ...
            {
                target: 'dashboard-grant-proposals',
                content: 'View and manage all your grant proposals here. Track their status, deadlines, and progress.',
                placement: 'bottom',
            ...
            {
                target: 'dashboard-deleted-proposals',
                content: 'View and manage all your deleted RFP proposals here. You can restore them within 15 days.',
                placement: 'top',
                title: 'Deleted RFP Proposals',
                disableBeacon: true,
                disableScrolling: false,
                scrollOffset: 80,
                page: '/dashboard',
            ...
            {
                target: 'dashboard-deleted-grant-proposals',
                content: 'View and manage all your deleted grant proposals here. You can restore them within 15 days.',
                placement: 'top',
                title: 'Deleted Grant Proposals',
                disableBeacon: true,
                disableScrolling: false,
                scrollOffset: 80,
                page: '/dashboard',
        ...
        '/employee-profile': [
            {
                target: 'employee-profile-overview',
                content: 'Welcome to your Employee Profile! Here you can see your employee information, proposals, and key statistics at a glance.',
                placement: 'bottom',
            ...
            {
                target: 'employee-profile-proposals',
                content: 'View your company\'s proposals here. You can see all the proposals your company has submitted, in-progress, and completed.',
                placement: 'top',
        ...
        '/discover': [
            ...
            {
                target: 'discover-saved-rfps',
                content: 'View all your saved RFPs and Grants here. Click on any item to view details, or remove it from your saved list.',
                placement: 'top',
                title: 'Saved RFPs & Grants',
                disableBeacon: true,
                disableScrolling: false,
                scrollOffset: 80,
                page: '/discover',
        ...
        '/proposals': [
            {
                target: 'saved-rfps',
                content: 'View all your saved RFPs here. You can unsave, share, or generate proposals from here.',
                placement: 'top',
            ...
            {
                target: 'draft-rfps',
                content: 'View all your draft RFPs here. You can unsave, share, or continue with the proposal generation process from here.',
                placement: 'top',
                title: 'Draft RFPs',
                disableBeacon: true,
                disableScrolling: false,
            ...
            {
                target: 'saved-grants',
                content: 'View all your saved Grants here. You can unsave, share, or generate grant proposals from here.',
                placement: 'top',
                title: 'Saved Grants',
                disableBeacon: true,
                disableScrolling: false,
            ...
            {
                target: 'draft-grants',
                content: 'View all your draft Grants here. You can unsave, share, or continue with the grant proposal generation process from here.',
                placement: 'top',
                title: 'Draft Grants',
                disableBeacon: true,
                disableScrolling: false,
